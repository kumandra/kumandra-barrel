...
import (
	...
	"github.com/kumandra/kumandra-barrel/initlz"
...
const (
	Name        = "kumandra-barrel"
	Description = "A mining program provided by Kumandra platform for storage miners."
)
...
func Command_Increase_Runfunc(cmd *cobra.Command, args []string) {
	...
	//Convert the deposit amount into TKMD units
